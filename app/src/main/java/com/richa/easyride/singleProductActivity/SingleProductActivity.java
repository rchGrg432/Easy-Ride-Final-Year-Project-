package com.richa.easyride.singleProductActivity;
...
//        if (cycle.getDiscountPrice() == 0 || cycle.getDiscountPrice() == null) {
//            price.setText("Rs. " + cycle.getPrice());
//            oldPrice.setVisibility(View.INVISIBLE);
//
//        } else {
//            price.setText("Rs. " + cycle.getDiscountPrice());
//            oldPrice.setText("Rs. " + cycle.getPrice());
//
//        }
